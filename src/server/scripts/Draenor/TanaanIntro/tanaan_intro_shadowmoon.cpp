...
/// 78994 - Yrel
class npc_tanaan_yrel : public PlayerScript
{
public:
    npc_tanaan_yrel() : PlayerScript("npc_tanaan_yrel") { }
...
/// 79675 - Lady Liadrin
class npc_maladaar_liadrin_tanaan_cave : public PlayerScript
{
public:
    npc_maladaar_liadrin_tanaan_cave() : PlayerScript("npc_maladaar_liadrin_tanaan_cave") { }
...
class go_iron_cage_door : public PlayerScript
{
public:
    go_iron_cage_door() : PlayerScript("go_iron_cage_door")
    {
        checkTimer = 1000;
    }
