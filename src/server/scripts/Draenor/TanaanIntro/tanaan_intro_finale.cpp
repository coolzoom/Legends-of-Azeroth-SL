...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        {
            AddGossipItemFor(player, GossipOptionIcon::None, "Yes, I need you to help me operate that enormous tank.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        if (action == GOSSIP_ACTION_INFO_DEF + 1)
        {
            ...
            player->SummonCreature(creature->GetEntry(), creature->GetPosition(), TEMPSUMMON_MANUAL_DESPAWN, 0, 0);
...
class npc_thaelin_tanaan_questgiver : public PlayerScript
{
public:
    npc_thaelin_tanaan_questgiver() : PlayerScript("npc_thaelin_tanaan_questgiver")
    {
    }
    ...
    bool OnQuestAccept(Player* player, Creature* creature, const Quest* quest)
    {
        ...
        {
            // On enlčve Thaelin avant le début de la cinématique, pour qu'il revienne correctement aprčs coté client
...
class gob_main_cannon_trigger : public PlayerScript
{
public:
    gob_main_cannon_trigger() : PlayerScript("gob_main_cannon_trigger")
    {
    }
