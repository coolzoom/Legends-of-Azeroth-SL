...
public:
    ...
    void OnSceneTriggerEvent(Player* player, uint32 sceneInstanceId, std::string p_Event)
    {
        if (!player->GetSceneMgr().HasScene(sceneInstanceId, TanaanSceneObjects::SceneDamExplosion))
            return;
...
/// 78553 - Thral
/// 78554 - Maladaar
class npc_thrall_maladaar_blackrock : public PlayerScript
{
public:
    npc_thrall_maladaar_blackrock() : PlayerScript("npc_thrall_maladaar_blackrock")
    {
    }
...
/// 79917 - Ganar
class npc_tanaan_ganar : public PlayerScript
{
public:
    npc_tanaan_ganar() : PlayerScript("npc_tanaan_ganar") { }
...
/// 231119 - Powder Keg
class gob_powder_keg : public PlayerScript
{
public:
    gob_powder_keg() : PlayerScript("gob_powder_keg") { }
...
class gob_makeshift_plunger : public PlayerScript
{
public:
    gob_makeshift_plunger() : PlayerScript("gob_makeshift_plunger") { }
