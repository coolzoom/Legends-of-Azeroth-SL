...
class npc_durotan_frostridge_begin : public PlayerScript
{
public:
    npc_durotan_frostridge_begin() : PlayerScript("npc_durotan_frostridge_begin") { }
...
public:
    ...
    struct go_wod_q34375AI : public GameObjectAI
    {
        ...
        void InitializeAI()
        {
            ...
            me->m_invisibility.AddFlag(INVISIBILITY_UNK7);
            me->m_invisibility.AddValue(INVISIBILITY_UNK7, 1000);
        }
