...
struct boss_xanesh : public BossAI
{
	...
	void ExecuteEvent(uint32 eventId) override
	{
		...
		case EVENT_OBELISKS:
		{
			me->DespawnCreaturesInArea2(NPC_RITUAL_OBELISK, 125.0f);
			me->DespawnCreaturesInArea2(NPC_LARGE_RITUAL_OBELISK, 125.0f);
			Talk(SAY_OBELISKS);
	...
	{
		me->DespawnCreaturesInArea2(NPC_GOAL_PORTAL, 125.0f);
	...
	{
		_JustReachedHome();
		me->DespawnCreaturesInArea2(NPC_FLAYED_SOUL, 125.0f);
		me->DespawnCreaturesInArea2(NPC_RITUAL_OBELISK, 125.0f);
		me->DespawnCreaturesInArea2(NPC_LARGE_RITUAL_OBELISK, 125.0f);
		me->DespawnCreaturesInArea2(NPC_AWAKENED_TERROR, 125.0f);
		me->DespawnCreaturesInArea2(NPC_FLAYED_SOUL, 125.0f);
		me->DespawnCreaturesInArea2(NPC_TORMENT_VEHICLE, 125.0f);
		me->DespawnCreaturesInArea2(NPC_VOID_ORB, 125.0f);
		me->DespawnCreaturesInArea2(NPC_GOAL_PORTAL, 125.0f);
