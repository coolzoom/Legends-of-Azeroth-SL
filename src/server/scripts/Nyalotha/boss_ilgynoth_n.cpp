...
private:
	...
	{
		me->DespawnCreaturesInArea2(NPC_ORGAN_OF_CORRUPTION, 125.0f);
		me->DespawnCreaturesInArea2(NPC_BLOOD_OF_NYALOTHA, 125.0f);
		me->DespawnCreaturesInArea2(NPC_CLOTTED_CORRUPTION, 125.0f);
