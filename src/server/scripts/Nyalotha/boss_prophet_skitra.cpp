...
private:
    ...
    void EnterEvadeMode(EvadeReason /*why*/) override
    {
        ...
        me->DespawnCreaturesInArea2(NPC_SHREDDED_PSYCHE, 125.0f);
        me->DespawnCreaturesInArea2(NPC_IMAGE_OF_ABSOLUTION, 125.0f);
        me->DespawnCreaturesInArea2(NPC_PROPGET_SKITRA_PROJECTION, 125.0f);
    ...
    void ExecuteEvent(uint32 eventId) override
    {
        ...
        case EVENT_BERSERK:
        {
            me->AddAura(SPELL_RAGE_OF_THE_CORRUPTOR, me);
            break;
        }
