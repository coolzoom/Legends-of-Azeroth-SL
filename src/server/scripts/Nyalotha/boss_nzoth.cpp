...
struct boss_nzoth : public BossAI
{
    ...
    void EnterEvadeMode(EvadeReason /*why*/) override
    {
        Talk(SAY_WIPE);
        _JustReachedHome();       
        me->DespawnCreaturesInArea2(NPC_PSYCHUS, 125.0f);
        me->DespawnCreaturesInArea2(NPC_EXPOSED_SYNAPSE, 125.0f);
        me->DespawnCreaturesInArea2(NPC_CORRUPTED_NEURON, 125.0f);
        me->DespawnCreaturesInArea2(NPC_BASHER_TENTACLE, 125.0f);
        me->DespawnCreaturesInArea2(NPC_CORRUPTOR_TENTACLE, 125.0f);
        me->DespawnCreaturesInArea2(NPC_SPIKE_TENTACLE, 125.0f);
