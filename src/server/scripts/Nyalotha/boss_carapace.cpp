...
private:
	...
	void SpellHitTarget(Unit* target, const SpellInfo* spellInfo) override
	{
		...
		case SPELL_MANDIBLE_SLAM:
			target->AddAura(SPELL_BLACK_SCAR, target);
	...
	{
		_JustReachedHome();
		me->DespawnCreaturesInArea2(NPC_NIGHTMARE_ANTIGEN, 300.0f);
		me->DespawnCreaturesInArea2(NPC_THRASHING_TENTACLE, 300.0f);
		me->DespawnCreaturesInArea2(NPC_GAZE_OF_MADNESS, 300.0f);
