...
private:
	...
	{
		_JustReachedHome();
		me->DespawnCreaturesInArea2(NPC_ESSENCE_OF_VITA, 125.0f);
		me->DespawnCreaturesInArea2(NPC_ESSENCE_OF_VOID, 125.0f);
		me->DespawnCreaturesInArea2(NPC_VOID_HUNTER, 125.0f);
		me->DespawnCreaturesInArea2(NPC_CRACKLING_STALKER, 125.0f);
		me->DespawnCreaturesInArea2(NPC_ESSENCE_OF_NIGHTMARE, 125.0f);
		me->DespawnCreaturesInArea2(NPC_NIGHT_TERROR, 125.0f);
		me->DespawnCreaturesInArea2(NPC_CRACKLING_STALKER, 125.0f);
...
struct npc_essence_raden : public ScriptedAI
{
	...
	void Reset() override
	{
		...
		case NPC_ESSENCE_OF_VITA:
			...
			me->AddAura(SPELL_INEVITABLE_PULL, me);
			break;
	...
	void JustDied(Unit* unit) override
	{
		...
		case NPC_ESSENCE_OF_VITA:
			if (Creature* raden = me->FindNearestCreature(NPC_RADEN, 100.0f, true))
				raden->AddAura(SPELL_UNCLAIMED_VITA, raden);
			me->DespawnOrUnsummon();
			break;

		case NPC_ESSENCE_OF_VOID:
			if (Creature* raden = me->FindNearestCreature(NPC_RADEN, 100.0f, true))
				raden->AddAura(SPELL_UNCLAIMED_VOID, raden);
			me->DespawnOrUnsummon();
			break;

		case NPC_ESSENCE_OF_NIGHTMARE:
			if (Creature* raden = me->FindNearestCreature(NPC_RADEN, 100.0f, true))
				raden->AddAura(SPELL_UNCLAIMED_NIGHTMARE, raden);
			me->DespawnOrUnsummon();
			break;
		}
	}
