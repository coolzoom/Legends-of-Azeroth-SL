...
private:
	...
	{	
		...
		me->DespawnCreaturesInArea2(NPC_DARK_MANIFESTATION, 125.0f);
        me->DespawnCreaturesInArea2(500506, 125.0f);
	...
	void DoAction(int32 param)
	{
		...
		case ACTION_OBSIDIAN_SKIN:             
			 ...
			 me->AddAura(OBSIDIAN_SKIN_VISUAL, me);
			 me->AddAura(OBSIDIAN_SKIN, me);
...
struct at_maut_devoured_abyss : public AreaTriggerAI
{
    ...
    void OnUnitEnter(Unit* unit) override
    {
        if (unit->IsPlayer())
        {
            ...
            unit->AddAura(DEVOURED_ABYSS_DRAIN_MANA, unit);
