...
class mob_spirit_of_the_crane : public PlayerScript
{
    public:
        mob_spirit_of_the_crane() : PlayerScript("mob_spirit_of_the_crane") {}
...
// Andruin Wrynn - 59608
class mob_anduin_wrynn : public PlayerScript
{
    public:
        mob_anduin_wrynn() : PlayerScript("mob_anduin_wrynn") {}
...
// Chi Ji - 59653
class npc_chi_ji : public PlayerScript
{
    public:
        npc_chi_ji() : PlayerScript("npc_chi_ji") {}

        bool OnGossipHello(Player* player, Creature* creature)
        {
            if (player->GetQuestStatus(30273) == QUEST_STATUS_INCOMPLETE)
            {
                AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_CHOICE, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
// Thelonius - 60506
class npc_thelonius : public PlayerScript
{
    public:
        npc_thelonius() : PlayerScript("npc_thelonius") {}
