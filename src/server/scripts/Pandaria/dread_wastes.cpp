    ...
    public:
        ...
        struct mob_dread_kunchongAI : public ScriptedAI
        {
            ...
            void JustEngagedWith(Unit* who) override
            {
                ...
                switch (player->GetSpecializationId2())
                {
...
class go_ancient_amber_chunk : public PlayerScript
{
    public:
        go_ancient_amber_chunk() : PlayerScript("go_ancient_amber_chunk") {}
...
class go_kunchong_cage : public PlayerScript
{
    public:
        go_kunchong_cage() : PlayerScript("go_kunchong_cage") {}
