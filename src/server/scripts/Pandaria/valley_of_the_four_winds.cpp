...
// Sheepie - 64391
class mob_sheepie : public PlayerScript
{
public:
    mob_sheepie() : PlayerScript("mob_sheepie") {}
...
// Sheepie - 64385/64386
class mob_second_sheepie : public PlayerScript
{
    public:
        mob_second_sheepie() : PlayerScript("mob_second_sheepie") {}
...
class mob_hillpaw_s_chicken : public PlayerScript
{
    public:
        mob_hillpaw_s_chicken() : PlayerScript("mob_hillpaw_s_chicken") {}
...
class mob_escaped_shagskin : public PlayerScript
{
    public:
        mob_escaped_shagskin() : PlayerScript("mob_escaped_shagskin") {}
...
class mob_jin_jao : public PlayerScript
{
    public:
        mob_jin_jao() : PlayerScript("mob_jin_jao") {}
...
class mob_jambeezi : public PlayerScript
{
    public:
        mob_jambeezi() : PlayerScript("mob_jambeezi") {}
...
class mob_lei_lan : public PlayerScript
{
    public:
        mob_lei_lan() : PlayerScript("mob_lei_lan") {}
...
// Lolo Lio - 59585
class mob_lolo_lio : public PlayerScript
{
    public:
        mob_lolo_lio() : PlayerScript("mob_lolo_lio") {}
