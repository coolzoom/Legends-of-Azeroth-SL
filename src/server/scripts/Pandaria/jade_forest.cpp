...
class mob_pandriarch_windfur : public CreatureScript
{
    public:
        ...
        {
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_CHOICE_1, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
class mob_big_bao : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_CHOICE_2, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
// Elder Anli - 58564
class npc_elder_anli : public PlayerScript
{
    public:
        npc_elder_anli() : PlayerScript("npc_elder_anli") {}
...
class mob_pearlfin_aqualyte : public PlayerScript
{
    public:
        mob_pearlfin_aqualyte() : PlayerScript("mob_pearlfin_aqualyte") {}
...
class mob_pearlfin_villager : public PlayerScript
{
    public:
        mob_pearlfin_villager() : PlayerScript("mob_pearlfin_villager") {}
...
class mob_pearlfin_situation : public PlayerScript
{
    public:
        mob_pearlfin_situation() : PlayerScript("mob_pearlfin_situation") {}
...
// Hozen Cage - 209586
// Initial LockId : 1979
class gob_hozen_cage : public PlayerScript
{
    public:
        gob_hozen_cage() : PlayerScript("gob_hozen_cage") {}
...
class mob_instructor_windblade : public PlayerScript
{
    public:
        mob_instructor_windblade() : PlayerScript("mob_instructor_windblade") {}
...
class npc_instructor_skythorn : public PlayerScript
{
    public:
        npc_instructor_skythorn() : PlayerScript("npc_instructor_skythorn") {}
...
// Fei - 56784
class npc_fei : public PlayerScript
{
    public:
        npc_fei() : PlayerScript("npc_fei") {}
