...
struct boss_ataldazar_yazma : public BossAI
{
    ...
    void JustDied(Unit* killer) override
    {
        ...
        if (IsHeroic() || IsMythic())
            instance->DoCompleteAchievement2(AtalDazarAchievements::ACHIEVEMENT_ATAL_DAZAR_COMPLETED_HEROIC);
        if (IsMythic())
            instance->DoCompleteAchievement2(AtalDazarAchievements::ACHIEVEMENT_ATAL_DAZAR_COMPLETED_MYTHIC);
        instance->DoCompleteAchievement2(AtalDazarAchievements::ACHIEVEMENT_ATAL_DAZAR_COMPLETED);
        ...
        if (instance->GetData(DATA_ACHIEVEMENT_COUNT) == 4)
            instance->DoCompleteAchievement2(AtalDazarAchievements::ACHIEVEMENT_BRINGING_HEXY_BACK);
    }
