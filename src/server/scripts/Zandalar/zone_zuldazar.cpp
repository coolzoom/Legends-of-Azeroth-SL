...
//123000
class npc_captain_rezokon_123000 : public PlayerScript
{
public:
    npc_captain_rezokon_123000() : PlayerScript("npc_captain_rezokon_123000") { }

    bool OnGossipHello(Player* player, Creature* creature)
    {
        AddGossipItemFor(player, GossipOptionIcon::None, "Let's go.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 0);
        AddGossipItemFor(player, GossipOptionIcon::None, "The Kul Tiran fleet is off the coast of Nazmir, get the fleet mobilized and attack them", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
//135690
class npc_dread_admiral_tattersail_135690 : public PlayerScript
{
public:
    npc_dread_admiral_tattersail_135690() : PlayerScript("npc_dread_admiral_tattersail_135690") { }

    bool OnGossipHello(Player* player, Creature* creature)
    {       
        AddGossipItemFor(player, GossipOptionIcon::None, "Set sail for Drustvar.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 0);
        AddGossipItemFor(player, GossipOptionIcon::None, "Set sail for Stormsong Valley.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        AddGossipItemFor(player, GossipOptionIcon::None, "Set sail for Tiragarde Sound.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
        ...
        {
            AddGossipItemFor(player, GossipOptionIcon::None, "Take us back to Zuldazar.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
            SendGossipMenuFor(player, 34711, creature->GetGUID());
            player->PrepareQuestMenu(creature->GetGUID());
        }
