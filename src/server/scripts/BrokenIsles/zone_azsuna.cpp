...
class npc_prince_farondis : public PlayerScript
{
public:
    npc_prince_farondis() : PlayerScript("npc_prince_farondis") { }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if (player->GetQuestStatus(37467) == QUEST_STATUS_INCOMPLETE) // The Walk of Shame
            AddGossipItemFor(player, GossipOptionIcon::None, "Please, show me where the Tidestone lies.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
// 250361
class go_sabotaged_portal_stabilizer : public PlayerScript
{
public:
    go_sabotaged_portal_stabilizer() : PlayerScript("go_sabotaged_portal_stabilizer") { }
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
            ...
            && creature->IsFullHealth())
        {
            ...
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_ACCEPT_DUEL, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
...
class go_pylon_mana245572 : public PlayerScript
{
public:
    go_pylon_mana245572() : PlayerScript("go_pylon_mana245572") { }
...
class go_pylon_mana245573 : public PlayerScript
{
public:
    go_pylon_mana245573() : PlayerScript("go_pylon_mana245573") { }
...
class go_pylon_mana239959 : public PlayerScript
{
public:
    go_pylon_mana239959() : PlayerScript("go_pylon_mana239959") { }
...
class go_pylon_mana245574 : public PlayerScript
{
public:
    go_pylon_mana245574() : PlayerScript("go_pylon_mana245574") { }
...
class go_fel_power_run244706 : public PlayerScript
{
public:
    go_fel_power_run244706() : PlayerScript("go_fel_power_run244706") { }
...
class go_soul_gem239338 : public PlayerScript
{
public:
    go_soul_gem239338() : PlayerScript("go_soul_gem239338") { }
...
class go_soul_gem239332 : public PlayerScript
{
public:
    go_soul_gem239332() : PlayerScript("go_soul_gem239332") { }
...
class go_soul_gem237017 : public PlayerScript
{
public:
    go_soul_gem237017() : PlayerScript("go_soul_gem237017") { }
