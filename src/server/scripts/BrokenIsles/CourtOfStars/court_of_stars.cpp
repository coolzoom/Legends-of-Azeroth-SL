...
class npc_cos_signal_lantern : public PlayerScript
{
    public:
        npc_cos_signal_lantern() : PlayerScript("npc_cos_signal_lantern")
        {}
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            AddGossipItemFor(player, GossipOptionIcon::None, "Send a signal to Ly'leth Lunastre.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
