...
public:
    ...
    struct npc_kayn_sunfury_welcome_AI : public ScriptedAI
    {
        ...
        void IsSummonedBy(WorldObject* summoner) override
        {
            ...
            player->SummonCreature(98228, 1182.36f, 3202.91f, 51.6049f, 4.88566f, TEMPSUMMON_MANUAL_DESPAWN, 16000);
            player->SummonCreature(98227, 1177.00f, 3203.07f, 51.3637f, 4.88746f, TEMPSUMMON_MANUAL_DESPAWN, 16000);
            player->SummonCreature(99918, 1172.92f, 3207.82f, 52.3935f, 3.73185f, TEMPSUMMON_MANUAL_DESPAWN, 16000);
            player->SummonCreature(98290, 1171.49f, 3203.69f, 51.3145f, 3.4564f, TEMPSUMMON_MANUAL_DESPAWN, 16000);
            player->SummonCreature(98292, 1170.74f, 3204.71f, 51.5426f, 3.36744f, TEMPSUMMON_MANUAL_DESPAWN, 16000);
        }
...
class go_mardum_legion_banner_1 : public PlayerScript
{
public:
    go_mardum_legion_banner_1() : PlayerScript("go_mardum_legion_banner_1") { }
...
class go_q39279 : public PlayerScript
{
public:
    go_q39279() : PlayerScript("go_q39279") { }
...
class go_mardum_portal_ashtongue : public PlayerScript
{
public:
    go_mardum_portal_ashtongue() : PlayerScript("go_mardum_portal_ashtongue") { }
...
class go_mardum_cage : public PlayerScript
{
public:
    go_mardum_cage(const char* name, uint32 insideNpc, uint32 killCredit = 0) : PlayerScript(name), _insideNpc(insideNpc), _killCredit(killCredit)
    {
        if (_killCredit == 0)
...
class npc_mardum_ashtongue_mystic : public PlayerScript
{
public:
    npc_mardum_ashtongue_mystic() : PlayerScript("npc_mardum_ashtongue_mystic") { }
...
class go_mardum_portal_coilskar : public PlayerScript
{
public:
    go_mardum_portal_coilskar() : PlayerScript("go_mardum_portal_coilskar") { }
...
class go_meeting_with_queen_ritual : public PlayerScript
{
public:
    go_meeting_with_queen_ritual() : PlayerScript("go_meeting_with_queen_ritual") { }
...
public:
        ...
        void MoveInLineOfSight(Unit* unit) override
        {
            if (Player* player = unit->ToPlayer())
                if (player->GetDistance(me) < 5.0f)
                    if (!player->IsQuestObjectiveProgressBarComplete(QUEST_SHIVARRA_FORCES, 0) && !_greetSaid) {
    ...
    {   
        if (!player->IsQuestObjectiveProgressBarComplete(QUEST_SHIVARRA_FORCES, 0) && !_sacrificeSevis && !_sacrificeMe) {
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_SEVIS1, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_SEVIS2, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
        ...
        case GOSSIP_ACTION_INFO_DEF + 1:
            ...
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_SEVIS3, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_SEVIS4, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
            SendGossipMenuFor(player, player->GetGossipTextId(creature), creature->GetGUID());
            return true;
        case GOSSIP_ACTION_INFO_DEF + 2:
            _sacrificeMe = true;
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_SEVIS5, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 5);
            AddGossipItemFor(player, GossipOptionIcon::None, GOSSIP_SEVIS4, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
            SendGossipMenuFor(player, player->GetGossipTextId(creature), creature->GetGUID());
            return true;
...
public:
    ...
    void OnPlayerReleasedGhost(Player* player)
    {
        if (player->getClass() == CLASS_DEMON_HUNTER && !player->IsCorpse()
            && player->IsQuestObjectiveProgressBarComplete(QUEST_SHIVARRA_FORCES, 0))
                player->PlayConversation(CONVERSATION_LORD_ILLIDAN);
    }
};

class go_mardum_portal_shivarra : public PlayerScript
{
public:
    go_mardum_portal_shivarra() : PlayerScript("go_mardum_portal_shivarra") { }
...
// 90247, 93693, 94435
class npc_mardum_captain : public PlayerScript
{
public:
    npc_mardum_captain() : PlayerScript("npc_mardum_captain") { }
...
class npc_mardum_jace_darkweaver : public PlayerScript
{
public:
    npc_mardum_jace_darkweaver() : PlayerScript("npc_mardum_jace_darkweaver") { }
...
public:
    ...
    struct npc_mardum_prolifica_AI : public CreatureAI
    {
        EventMap events;
        ObjectGuid playerGuid;

        npc_mardum_prolifica_AI(Creature* creature) : CreatureAI(creature)
        {
    ...
    struct npc_general_volroth_AI : public ScriptedAI
    {
        ...
        void JustDied(Unit* killer) override
        {
            ...
            if (killer->GetTypeId() == TYPEID_PLAYER) {
                ...
                me->FindNearestCreature(96561, 30.0f);
                ...
                me->FindNearestCreature(96230, 30.0f);
        ...
        void UpdateAI(uint32 diff) override {
            ...
            while (uint32 eventId = events.ExecuteEvent()) {
                switch (eventId) {
                    ...
                    case EVENT_STUN:
                        me->CastStop();
                        events.DelayEvents(EVENT_STORM, 10000);
                        events.DelayEvents(EVENT_CLEAVE, 10000);
...
class go_well_of_souls : public PlayerScript
{
public:
    go_well_of_souls() : PlayerScript("go_well_of_souls") { }
...
class go_mardum_illidari_banner : public PlayerScript
{
public:
    go_mardum_illidari_banner() : PlayerScript("go_mardum_illidari_banner") { }
...
class go_mardum_tome_of_fel_secrets : public PlayerScript
{
public:
    go_mardum_tome_of_fel_secrets() : PlayerScript("go_mardum_tome_of_fel_secrets") { }
...
class npc_mardum_dh_learn_spec : public PlayerScript
{
public:
    npc_mardum_dh_learn_spec() : PlayerScript("npc_mardum_dh_learn_spec") { }
...
// 96653
class npc_mardum_izal_whitemoon : public PlayerScript
{
public:
    npc_mardum_izal_whitemoon() : PlayerScript("npc_mardum_izal_whitemoon") { }
    ...
    struct npc_brood_queen_tyrannaAI : public ScriptedAI
    {
        ...
        void DamageTaken(Unit* attacker, uint32& damage) override
        {
            ...
            if (damage >= me->GetHealth())
            {
                ...
                me->GetThreatManager().GetSortedThreatList();
...
// 245728
class go_mardum_the_keystone : public PlayerScript
{
public:
    go_mardum_the_keystone() : PlayerScript("go_mardum_the_keystone") { }
