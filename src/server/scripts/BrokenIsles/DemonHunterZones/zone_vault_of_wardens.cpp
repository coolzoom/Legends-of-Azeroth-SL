...
// 103658
class npc_kayn_cell : public PlayerScript
{
public:
   npc_kayn_cell() : PlayerScript("npc_kayn_cell") { }
   ...
   bool OnGossipHello(Player* player, Creature* creature)
   {
       if (player->GetQuestStatus(QUEST_BREAKING_OUT) == QUEST_STATUS_INCOMPLETE)
       {
           ...
           player->SummonCreature(99631, 4343.16f, -589.57f, -281.40f, 3.38f, TEMPSUMMON_TIMED_DESPAWN, 60000);
       }
       return true;
   }
};
...
// 103655
class npc_altruis_cell : public PlayerScript
{
public:
    npc_altruis_cell() : PlayerScript("npc_altruis_cell") { }
    ...
    {   
        if (player->GetQuestStatus(QUEST_BREAKING_OUT) == QUEST_STATUS_INCOMPLETE)
        {
            ...
            creature->DespawnOrUnsummon(60);
            player->SummonCreature(99632, 4309.94f, -589.618f, -281.407f, 6.13126f, TEMPSUMMON_TIMED_DESPAWN, 60000);
        }
        return true;
    }
};
...
// 92986 Altruis
class npc_altruis : public PlayerScript
{
public:
    npc_altruis() : PlayerScript("npc_altruis") { }
...
// 96665 kayn
class npc_kayn_3 : public PlayerScript
{
public:
    npc_kayn_3() : PlayerScript("npc_kayn_3") { }
...
// 243967
class go_reflective_mirror : public PlayerScript
{
public:
    go_reflective_mirror() : PlayerScript("go_reflective_mirror") { }
...
// 243967
class go_pool_of_judgements : public PlayerScript
{
public:
    go_pool_of_judgements() : PlayerScript("go_pool_of_judgements") { }
...
class npc_korvas_bloodthorn : public PlayerScript
{
public:
    npc_korvas_bloodthorn() : PlayerScript("npc_korvas_bloodthorn") { }
...
// 20543507 (97978)
class npc_khadgar : public PlayerScript
{
public:
    npc_khadgar() : PlayerScript("npc_khadgar") { }
    enum eKhadgar {
...
class npc_maiev_shadowsong : public PlayerScript
{
public:
    npc_maiev_shadowsong() : PlayerScript("npc_maiev_shadowsong") { }
    enum {
...
class npc_legion_portal : public PlayerScript
{
public:
    npc_legion_portal() : PlayerScript("npc_legion_portal") { }
...
public:
    ...
    void Handle100DHArrival(Player* player)
    {
        if (player->getClass() == CLASS_DEMON_HUNTER)
        {
            ...
            if (player->GetSpecializationId2() == TALENT_SPEC_DEMON_HUNTER_HAVOC) {
