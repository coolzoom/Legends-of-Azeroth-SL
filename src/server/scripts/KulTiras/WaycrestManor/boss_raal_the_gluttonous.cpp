...
struct boss_raal_the_gluttonous : public BossAI
{
	...
	void MoveInLineOfSight(Unit* target) override
	{
		...
		if (target->GetDistance2d(me) >= 35.0f && target->IsPlayer() && me->IsInCombat())
		{
			...
			me->DespawnCreaturesInArea2(NPC_WASTING_SERVANT, 125.0f);
			me->DespawnCreaturesInArea2(NPC_BILE_OOZELING, 125.0f);
	...
	void JustDied(Unit* u) override
	{
		...
		me->DespawnCreaturesInArea2(NPC_BILE_OOZELING);
		me->DespawnCreaturesInArea2(NPC_WASTING_SERVANT);
	}
};
