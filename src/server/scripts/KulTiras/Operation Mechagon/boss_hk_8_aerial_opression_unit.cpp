...
struct npc_hk8_arena_center_stalker : public ScriptedAI
{
    ...
    {
        ScriptedAI::Reset();
        me->DespawnCreaturesInArea2(NPC_HK_8_AERIAL_OPPRESION_UNIT, 125.0f);
        me->DespawnCreaturesInArea2(NPC_TANK_BUSTER_MK1, 125.0f);
        me->DespawnCreaturesInArea2(NPC_WALKIE_SHOCKIE_X1, 125.0f);
        me->DespawnCreaturesInArea2(NPC_TANK_BUSTER_MK2, 125.0f);
